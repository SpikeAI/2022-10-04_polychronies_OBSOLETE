...
%	LETTER CONTENT
%----------------------------------------------------------------------------------------
Many thanks for accepting our manuscript entitled ``Precise spiking motifs in neurobiological and neuromorphic data'' for your consideration as a review paper in \emph{Brain Sciences}. We are very grateful to the reviewers for their very insightful remarks and we have now responded to all their remarks. 


We have accepted all changes suggested at the proofreading stage and uploaded our files on the MDPI website.
