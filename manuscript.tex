...
% This key in not used in the paper abeles_role_1982
% This key in not used in the paper aronov_non-euclidean_2004
% This key in not used in the paper bellec_fitting_2021
% This key in not used in the paper benosman_asynchronous_2012
% This key in not used in the paper benosman_event-based_2014
% This key in not used in the paper bernert_attention-based_2018
% This key in not used in the paper bernert_fully_2017
% This key in not used in the paper bohte_error-backpropagation_2002
% This key in not used in the paper dardelet_event-by-event_2021
% This key in not used in the paper duffy_variation_2019
% This key in not used in the paper foss_multistability_2000
% This key in not used in the paper ganguli_memory_2008
% This key in not used in the paper gerstner_time_1995
% This key in not used in the paper ghosh_synchronization_2021
% This key in not used in the paper grun_unitary_2002-1
% This key in not used in the paper haessig_event-based_2020
% This key in not used in the paper izhikevich_polychronous_2009
% This key in not used in the paper jeremie_ultra-fast_2022
% This key in not used in the paper lagorce_hots_2017
% This key in not used in the paper madadi_asl_delay-dependent_2022
% This key in not used in the paper orban_neural_2016
% This key in not used in the paper pang_fast_2019
% This key in not used in the paper perrinet_motion-based_2012
% This key in not used in the paper puchalla_redundancy_2005
% This key in not used in the paper roelfsema_visuomotor_1997
% This key in not used in the paper singer_visual_1995
% This key in not used in the paper state_training_2019
% This key in not used in the paper stringer_spontaneous_2019
% This key in not used in the paper suthers_motor_2002
% This key in not used in the paper torre_asset_2016
% This key in not used in the paper warner_probabilistic_2022
% This key in not used in the paper wild_descending_1993
% This key in not used in the paper yarbus_eye_1961
% This key in not used in the paper yu_temporal_1996
% This key in not used in the paper zenke_remarkable_2021
% This key in not used in the paper zhao_understanding_2011
...
\abstract{
Why do neurons communicate through spikes? By definition, a spike is an all-or-none event which occurs at continuous times. In other words, spikes are on one side binary, they occur or not without further details,  and second can occur at any asynchronous time, without a centralized clock. This stands in stark contrast to the discretized timing classically used in digital processing at the base of modern-day neural networks. In the living world, neural systems almost systematically use this so-called event-based representation. A better understanding of this phenomenon remains a fundamental challenge in neurobiology in order to better interpret the masses of recorded data. It is also an emerging topic in computer science to allow the efficient exploitation of a new class of sensors and event-based computers, called neuromorphic, which could allow significant gains in computing time and energy consumption ---a major societal mission in the age of the digital economy and of global warming. In this review paper, we provide evidence from biology and engineering that the precise timing of spikes plays a crucial role in our understanding of the efficiency of neural networks.
}
...
\subsection{Decoding neural activity using spike distances}\label{sec:detection}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
There are different solution to provide with a distance between two given spike trains. A known measure is the Victor-Purpura distance, which showed that their findings are inconsistent with Poisson models of spike trains~\citep{victor_nature_1996}. In a later study,~\citet{van_rossum_novel_2001} have defined a distance that has a time constant as a parameter. Depending on this parameter, the distance interpolates between a coincidence detector and a rate difference counter. Such distances were extended to non-Euclidean metrics and use morphological manipulations to compute spike train dissimilarity~\citet{kreuz_measuring_2007}. Mathematically, the stability of distance measures induced by level-crossing sampling can be evaluated~\citep{moser_stability_2014}, notably in light of Weyl's discrepancy measure~\citep{weyl_ueber_1916} which may lead to the definition of a cross-correlation measure which is adapted to the event-based nature of spiking signals. These observations lead to the intuition that each distance may be related as the optimal solution of a generative model for these measures. % ~\citep{} 
...
% autres méthodes
spatitemporal kernels: \citep{yu_stsc-snn_2022}
...
Clustering and control for adaptation uncovers time-warped spike time patterns in cortical networks in vivo~\citep{isbister_clustering_2021} They discovered (in vivo) that the times that individual neurons spiked within a sequence depended on the excitability of the cortex when a stimulus was presented.
% dynamical models
