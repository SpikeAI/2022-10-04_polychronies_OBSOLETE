...
\begin{figure}%[t!]
  ...
  \includegraphics[width=0.490\linewidth]{figures/THC_1a.pdf}
    ...
    {\bf (c)}~By defining a layer of neurons that detect these PGs such that the addresses are the synapses of these neurons (which we therefore call here synapses).
...
\acknowledgments{We would like to thank Jean-Nicolas Jérémie, Hugo LAdret for useful discussions while writing this review.}
