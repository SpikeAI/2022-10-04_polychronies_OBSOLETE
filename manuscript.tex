...
%=================================================================
\documentclass[arts,review,submit,pdftex,moreauthors]{Definitions/mdpi} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\note{TODO: a paragraph saying that we think of neurons of integrators, but that they may also switch to a mode fro synchrony detection}~\citep{paugam-moisy_computing_2012}
