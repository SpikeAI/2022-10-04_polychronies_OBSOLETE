...
% polychronization
Interestingly the paper by~\citet{izhikevich_polychronization_2006} stirred a debate in the field of computational neuroscience, with a general postive acceptance, but quite few works extended this seminal paper.
...
A notable exception is an extensive work aiming at reproducing the polychronization model~\citep{pauli_reproducing_2018}. Indeed, the original paper contained material within the text to reproduce the whole model. This more recent work details how this code was slighlty corrected. It comes with python code and a version control system detailing the whole process used to give provenance to the different steps in this scientific process.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Application to Image processing}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
may be used for motion detection and interpolation~\citep{kaplan_anisotropic_2013}~\citep{khoei_flash-lag_2017}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{Precise spiking motifs in neurobiology}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
