...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\add[Antoine]{In this first section, we have introduced the notion of rate coding and demonstrated that spike timing can also carry information. Experimentally, there are multiple pieces of evidence that neurons use different strategies to communicate. Population coding \citep{Maunsell_Functional_1983}, time-to-first-spike (described above), phase-of-firing code~\cipte{montemurro_phase-of-firing_2008}, correlation coding~\cite{decharms_primary_1996}, sparse coding~\citep{vinje_sparse_2000}, }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
