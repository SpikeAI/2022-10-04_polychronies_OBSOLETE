...
\subsection{Cell assemblies at multiple time scales with arbitrary lag constellations}
...
\subsection{learning pattern detection on natural images / event-based cameras}
