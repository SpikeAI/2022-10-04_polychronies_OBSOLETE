...
\begin{figure}%[t!]
  ...
  \includegraphics[width=0.980\linewidth]{figures/izhikevitch_repro.png}% https://www.overleaf.com/5625872443qpcwrkssgbsf
    ...
    \textit{(Right)}~If the pulses are emitted from presynaptic neurons such that, taking into account the delays, they reach the post-synaptic neuron \textit{a} at the same time (here, at $t=10~\ms$), then a spike is emitted (red color), while none is emitted from post-synaptic neuron \textit{e}.
     }
