...
%=================================================================
\documentclass[brainsci,review,submit,pdftex,moreauthors,draft]{Definitions/mdpi} 
...
Numerous studies demonstrated the importance of precise timing in neural population activity~\citep{ref-BNK6T5Uk}, efficient encoding thanks to the use of spike latencies~\citep{ref-1DpSM1kpQ}{10},\protect\hyperlink{ref-IjepoonT} or precise timing in the auditory system~\citep{ref-mxPMgOmW}{12},\protect\hyperlink{ref-1ECJhg2GM}. All these findings, and more~\citep{ref-WZsEyOlK}, highlight the importance of the temporal aspect of the neural code and suggest the existence of repeated spatio-temporal patterns in the spike train. Note also that depending on how an in vitro cell is driven, this may influence the reliability of spike timing in neocortical neurons~\citep{ref-XsHCA4IZ}.
...
\subsubsection{\texorpdfstring{Spike Synchronization and Rate Modulation Differentially Involved in Motor Cortical Function~\citep{ref-wVZpQvSk}}{Spike Synchronization and Rate Modulation Differentially Involved in Motor Cortical Function {[}42{]}}}\label{spike-synchronization-and-rate-modulation-differentially-involved-in-motor-cortical-function-doi10.1126science.278.5345.1950}
...
>>>>>>> b323f68914b4cec0ae69deafedb1b4102510b672
...
\item
  described in~\citep{ref-zc16plUu}{100}{]}
\item
...
\subsubsection{\texorpdfstring{Stringer et al 2019, Nature~\citep{ref-brg2FFsb}{101}{]}}{Stringer et al 2019, Nature {[}101{]}}}\label{stringer-et-al-2019-nature-stringer2019nature}
\begin{itemize}
\tightlist
\item
...
\subsubsection{\texorpdfstring{Stringer et al 2019, Science~\citep{ref-1BPHUQLTf}{102}{]}}{Stringer et al 2019, Science {[}102{]}}}\label{stringer-et-al-2019-science-stringer2019science}
\begin{itemize}
\item
...
\item
  see also the work showing that you can encode very precise orientation information by using many neurons:~\citep{ref-1EMs3GS0B}{103}{]}
\end{itemize}

\subsection{detecting structured temporal patterns}\label{detecting-structured-temporal-patterns}
\subsubsection{\texorpdfstring{Paper by Grossberger, 2018~\citep{ref-9AK1cwY1}{104}{]}}{Paper by Grossberger, 2018 {[}104{]}}}\label{paper-by-grossberger-2018-grossberger2018}
\begin{itemize}
\tightlist
\item
...
\subsubsection{\texorpdfstring{Paper by Russo et al 2017~\citep{ref-RrgzWOSk}}{Paper by Russo et al 2017 {[}88{]}}}\label{paper-by-russo-et-al-2017-russo2017}
\begin{itemize}
\tightlist
\item
...
\item
  sliding window as in~\citep{ref-1XpTamcl}{105}{]} (``Numerous other statistical procedures for detecting assemblies or sequential patterns have been proposed previously'') - extended to multiple lags~\citep{ref-bc9czTxi}
\item
...
\subsubsection{\texorpdfstring{Neural Variability and Sampling-Based Probabilistic Representations in the Visual Cortex~\citep{ref-1300cS9RL}{106}{]}}{Neural Variability and Sampling-Based Probabilistic Representations in the Visual Cortex {[}106{]}}}\label{neural-variability-and-sampling-based-probabilistic-representations-in-the-visual-cortex-orban2016}
\begin{itemize}
\tightlist
\item
...
\item
  In Bellec~\citep{ref-aj6TgorR}{125}{]}, authors fit summary statistics of neural data with a differentiable spiking network simulator.

  \begin{itemize}
  \tightlist
  \item
    the loss function is the cross entropy (following Bernouilli hypothesis with a GLM where each unit is modelled with a SRM neuron~\citep{ref-14e3BCBii}{126}{]} with recurrent dynamics)
  \item
...
Pang R, Fairhall AL.Elife. 2019 May~\citep{ref-12zyUFdO4}{128}{]}
...
Dumas and colleagues~\citep{ref-WxQdcMB2}{129}{]} : three levels / fourth paradigm~\citep{ref-JrZPoxk9}{130}{]} i.e., data exploration in which the scientific models are fit to the data by learning algorithms.
...
Emergence of electronic architectures specialized in Sparse Event-Based Convolutions~\citep{ref-sJ03d2Zj}{131}{]} or of sparsity aware algorithms~\citep{ref-R5BYFgCP}{132}{]}.
...
scaffolding of neural assemblies / existence of critical periods :~\citep{ref-1HSyNOl48}{133}{]}
