...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Let us start our review of the state of the art on the role of dynamics in vision. Vision is the set of processes which allow to make sense of the luminous world, and it is an intensively studied field in neuroscience with respect to the question of the neural code. In most mammals, light enters the eye to induce a neural activity on the retina, while keeping a certain homology between visual space and retinotopy. The origins of visual neuroscience may be found in Pierre Flouren's early experiments showing the dependence of visual perception upon cerebral cortex (Fite). In a series of seminal studies, hubel_receptive_1968 have shown that this activity could be selective to different features, such as orientation or motion . Remarkably, there exists a monotonous relationship between the visual contrast of the features and the firing rate of neurons. However, there is no consensus as to explain the multiple non-linear mechanism which transform the visual scene into a map of vernal activity, while they seem to be an essential piece to that puzzle (carandini_normalization_2012). 
