...
\caption{Latency coding. An input analog profile is encoded in latencies: the higher the contrast, the shorter the latency. In this example, one generates at most one spike per neuron. %From~\citep{ref-YX5wqWH4}
}\label{fig:roc}
\end{figure}
...
-\textgreater{} insert fig 2 of~\citep{izhikevich_polychronization_2006}
