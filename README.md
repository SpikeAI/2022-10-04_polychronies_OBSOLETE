...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/SpikeAI/polychronies/tree/gh-pages) and [`output`](https://github.com/SpikeAI/polychronies/tree/output) branches.
...
Please attribute by linking to https://github.com/SpikeAI/polychronies.
...
Please open [an issue](https://github.com/SpikeAI/polychronies/issues) for any question related to licensing.
